      ...
      <div className="portfolio__items">
        <div className="portfolio__item">
          ...
          <div className="portfolio__layer">
            ...
            <p className="portfolio__description">
              To support Mzamomtsha Primary School in their mission to provide
              education to their community, I created a website for the school.
            </p>
            <a
        ...
        <div className="portfolio__item">
          ...
          <div className="portfolio__layer">
            ...
            <p className="portfolio__description">
              The Application or system calculator calculates the tax obligation
              for an individual given his/her annual income.
            </p>
            <a
        ...
        <div className="portfolio__item">
          ...
          <div className="portfolio__layer">
            ...
            <p className="portfolio__description">
              A small financial App that allows the user to access two different
        ...
        <div className="portfolio__item">
          ...
          <div className="portfolio__layer">
            ...
            <p className="portfolio__description">
              Chat Application that allows two users to chat on different
              computers.
            </p>
            <a
              href="https://github.com/mzimasimbongwe?tab=repositories"
        ...
        <div className="portfolio__item">
          ...
          <div className="portfolio__layer">
            ...
            <p className="portfolio__description">
              ...
              <br />
              Bank Data.txt to keep all your bank information e.g. money you
              have in your account
              <br />
              Transaction Log.txt to keep your transactions e.g. your
