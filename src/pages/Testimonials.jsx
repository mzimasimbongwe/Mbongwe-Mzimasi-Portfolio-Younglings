...
const Testimonial = () => {
    const testimonials = [
        ...
        { id: 2, name: "Anganathi Zingca", role: "Vox Telecom Technian", designation: "", package: "Mzimasi is an excellent team player who works collaboratively with others to achieve common goals. He is always willing to lend a helping hand, share his knowledge and expertise, and provide guidance and support to his colleagues.", image: "https://i.ibb.co/4WLw8Y5/Whats-App-Image-2023-08-16-at-16-03-21-2-removebg-preview.png" },
        { id: 3, name: "Kenneth Basjan", role: "Younglings Junior Software Developer", designation: "I have never been so impressed with someone's work ethic like this before. Mzimasi has been such a blessing to my business. I highly recommend him, especially if you have any request that need Web and Apps  Development .", image: "https://i.ibb.co/zXgv5Bv/20230331125920-IMG-1968-removebg-preview.png" }
      ];
                  ...
                  <a href="#" target="_blank" className="testimonial_stories_link">
                      <div className="testimonial_card zoom">
                          <div className="testimonial_text">
                              ...
                              <p className="testimonial_role">{testimonials[activeIndex].role}</p>
